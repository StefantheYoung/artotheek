...
<div class="panel panel-default">
	<div class="panel-heading">Wijzig evenement</div>
	<div class="panel-body">
		{!! Form::open(['class' => 'form-horizontal', 'id' => 'form']) !!}
			<div class="form-group">
				{!! Form::label('Titel', null, ['class' => 'col-md-4 control-label']) !!}
				<div class="col-md-6">
					{!! Form::text('title', $event->title, ['class' => 'form-control', 'id' => 'tbx-title']) !!}
				</div>
			</div>
			<div class="form-group">
				{!! Form::label('Inhoud', null, ['class' => 'control-label col-md-1']) !!}
				<div class="col-md-12">
					{!! Form::textarea('content', $event->content, ['class' => 'form-control', 'id' => 'textarea-content']) !!}
				</div>
			</div>
			<div class="form-group">
